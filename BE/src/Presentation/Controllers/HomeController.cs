...
namespace BookSharing.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        {
            return View(new ErrorViewModel { Code = 500, Status="Internal Error", Message = "Произошла ошибка сервера. ID запроса: " + Activity.Current?.Id ?? HttpContext.TraceIdentifier });
        }
    }
}
