...
namespace BookSharing
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<BookSharingContext>(options => options.UseSqlServer(Configuration.GetConnectionString("BookSharingDev"), b => b.MigrationsAssembly("Presentation")))
